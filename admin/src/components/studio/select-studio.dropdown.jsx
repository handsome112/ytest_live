...
class SelectStudioDropdown extends react_1.PureComponent {
    ...
    async loadStudios(q) {
        ...
        const resp = await studio_service_1.studioService.search({ limit: 1000 });
...
exports.SelectStudioDropdown = SelectStudioDropdown;
