...
class AvatarUpload extends react_1.PureComponent {
    ...
    render() {
        ...
        return (<antd_1.Upload name="avatar" listType="picture-card" className="avatar-uploader" showUploadList={false} action={uploadUrl} beforeUpload={this.beforeUpload.bind(this)} onChange={this.handleChange} headers={headers} accept={env_1.default.imageAccept || 'image/*'}>
