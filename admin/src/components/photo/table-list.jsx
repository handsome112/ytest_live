...
class TableListPhoto extends react_1.PureComponent {
    render() {
        const columns = [
            {
                title: '',
                dataIndex: 'thumbnail',
                render(data, record) {
                    return <thumbnail_photo_1.ThumbnailPhoto photo={record}/>;
                }
            },
            {
                title: 'Title',
                ...
                render: (id) => {
                    return (<dropdown_action_1.DropdownAction menuOptions={[
                      ...
                      <icons_1.DeleteOutlined /> Delete
                                ...
                                onClick: () => this.props.deletePhoto && this.props.deletePhoto(id)
                            }
                        ]}/>);
                }
            }
...
exports.TableListPhoto = TableListPhoto;
