    ...
    render() {
        ...
        <antd_1.Col xl={{ span: 4 }} md={{ span: 8 }}>
          <antd_1.Select defaultValue="" style={{ width: '100%' }} onChange={status => this.setState({ status })}>
            ...
            <antd_1.Select.Option value="publised">Published</antd_1.Select.Option>
            <antd_1.Select.Option value="draft">Draft</antd_1.Select.Option>
          </antd_1.Select>
        </antd_1.Col>
        <antd_1.Col xl={{ span: 4 }} md={{ span: 8 }}>
          <antd_1.Button type="primary" onClick={() => this.props.onSubmit(this.state)}>Search</antd_1.Button>
        </antd_1.Col>
      </antd_1.Row>);
    }
}
