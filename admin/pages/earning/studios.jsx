...
class StudioEarningPage extends react_1.PureComponent {
    ...
    async loadStats() {
        ...
        try {
            const resp = await services_1.earningService.stats(Object.assign(Object.assign(Object.assign({}, query), { target }), filter));
    ...
    render() {
        ...
        <page_1.default>
          <antd_1.PageHeader title="Studio Earning" style={{ padding: 0, marginBottom: 10 }}/>
          <antd_1.Row className="ant-page-header" style={{ padding: 0 }}>
            ...
            <antd_1.Col md={12} xs={24}>
              {!loading && stats && (<antd_1.Space size="large" style={{ display: 'flex' }}>
                  <antd_1.Statistic title="Paid Tokens" value={stats.data.paidPrice} precision={2}/>
                  <antd_1.Statistic title="Remaining Tokens" value={stats.data.remainingPrice} precision={2}/>
                  <antd_1.Statistic title="Total Tokens" value={stats.data.totalPrice} precision={2}/>
                  <antd_1.Statistic title="Current Conversion Rate" value={this.props.conversionRate || 'N/A'} precision={2}/>
                </antd_1.Space>)}
            </antd_1.Col>
          </antd_1.Row>
          {/* <div>
          ...
          {data ? (<div>
              <search_filter_1.SearchFilter onSubmit={this.handleFilter.bind(this)} notWithKeyWord={true} searchWithStudio={true}/>
...
exports.default = react_redux_1.connect(mapStateToProps)(StudioEarningPage);
