...
const table_list_1 = require("@components/gallery/table-list");
const common_1 = require("@components/common");
class Galleries extends react_1.PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            pagination: {},
    ...
    async search(page = 1) {
        try {
            ...
            const resp = await gallery_service_1.galleryService.search(Object.assign(Object.assign({}, this.state.filter), { limit: this.state.limit, offset: (page - 1) * this.state.limit, sort: this.state.sort, sortBy: this.state.sortBy }));
            await this.setState({
                searching: false,
                list: resp.data.data,
    ...
    async deleteGallery(id) {
        ...
        try {
            await gallery_service_1.galleryService.delete(id);
    ...
    render() {
        ...
        <common_1.BreadcrumbComponent breadcrumbs={[{ title: 'Galleries' }]}/>
        <page_1.default>
          ...
          <table_list_1.TableListGallery dataSource={list} rowKey="_id" loading={searching} pagination={pagination} onChange={this.handleTableChange.bind(this)} deleteGallery={this.deleteGallery.bind(this)}/>
        </page_1.default>
      </react_1.Fragment>);
    }
}
