...
class PayoutRequestPage extends react_1.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            loading: true,
    ...
    async getList() {
        ...
        try {
            const resp = await services_1.payoutRequestService.search(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, filter), sort), { offset }), query), { sourceType, limit: pagination.pageSize }));
            await this.setState({
                data: resp.data.data,
...
exports.default = PayoutRequestPage;
