...
const publisher_1 = __importDefault(require("@components/streaming/webrtc/groupchat/publisher"));
const subscriber_1 = __importDefault(require("@components/streaming/webrtc/groupchat/subscriber"));
...
class UserPrivateChat extends react_1.PureComponent {
    ...
    componentDidMount() {
        ...
        this.mainVideoRef = react_1.default.createRef();
    ...
    async joinGroupChat() {
        const { performer, getStreamConversationSuccess: dispatchGetStreamConversationSuccess, loadMoreStreamMessages: dispatchLoadStreamMessages } = this.props;
        try {
        ...
        <div className="container">
          <antd_1.Row>
            <antd_1.Col md={12} xs={24}>
              {!roomJoined ? (<antd_1.Button type="primary" onClick={this.joinGroupChat.bind(this)} loading={processing} block>
                  Join Conversation
              ...
              <antd_1.Row className={this.remoteVideoContainerClassname}>
                <publisher_1.default {...this.props} id={this.localVideoId} ref={this.publisherRef} classNames="ant-col ant-col-6" containerClassName={this.remoteVideoContainerClassname} configs={{
                localVideoId: this.localVideoId
            }}/>
                <subscriber_1.default {...this.props} ref={this.subscriberRef} classNames="ant-col ant-col-6" onClick={this.handleRemoteVideo.bind(this)} containerClassName={this.remoteVideoContainerClassname} configs={{
                isPlayMode: true
            }}/>
              </antd_1.Row>
