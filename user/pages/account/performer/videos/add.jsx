...
class CreatePerformerVideosPage extends react_1.PureComponent {
    ...
    async onFinish(data) {
        ...
        try {
            ...
            await services_1.videoService.create('/performer/performer-assets/videos/upload', Object.assign(Object.assign({}, data), { performerId: performer._id }));
            antd_1.message.success('Add video success.');
    ...
    render() {
        ...
        <div className="performer-videos-page">
          <page_header_1.default title="Create new Video"/>
          <video_form_1.default loading={onSubmit} onFinish={this.onFinish.bind(this)} video={{}}/>
        </div>
      </>);
    }
}
