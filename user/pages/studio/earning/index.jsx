...
class PerformerProductsPage extends react_1.PureComponent {
    ...
    render() {
        var _a;
        const { data, searching, total, studio, stats, success } = this.props;
            ...
            <antd_1.Col md={12} xs={24}>
              <antd_1.Space>
                ...
                <span style={{ color: lib_1.defaultColor.primaryColor }}>
                  {(_a = studio.balance) === null || _a === void 0 ? void 0 : _a.toFixed(2)}
                  {' '}
                  tokens
                </span>
              </antd_1.Space>
...
const mapStateToProps = (state) => (Object.assign(Object.assign({}, state.studio.earning), { studio: state.studio.current }));
const mapDispatch = { getStudioEarning: actions_1.getStudioEarning };
