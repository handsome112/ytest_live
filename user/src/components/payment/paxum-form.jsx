...
exports.PaxumSettingForm = void 0;
...
const PaxumSettingForm = ({ onFinish, paymentInformation, loading }) => {
    const [form] = antd_1.Form.useForm();
    react_1.useEffect(() => {
        form.setFieldsValue(paymentInformation);
    }, [paymentInformation]);
    return (<antd_1.Form {...lib_1.formItemLayout} form={form} layout="vertical" onFinish={onFinish} name="paxumSettingForm" className="performerEditForm" initialValues={Object.assign({}, initFormValue)}>
...
exports.PaxumSettingForm = PaxumSettingForm;
