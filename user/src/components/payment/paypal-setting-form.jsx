...
exports.PaypalSettingFrom = void 0;
...
const PaypalSettingFrom = ({ onFinish, paymentInformation, loading }) => {
    ...
    return (<antd_1.Form {...formItemLayout} form={form} layout="vertical" onFinish={onFinish} name="paymentInfoSettingForm" className="performerEditForm" validateMessages={{ required: 'This field is required!' }} initialValues={Object.assign({}, initFormValue)}>
      <antd_1.Row>
        <antd_1.Col xs={24} sm={12}>
          ...
          <Item name="payPalAccount" key="payPalAccount" label="PayPal Account" dependencies={['type']} rules={[{ required: true }]}>
            <antd_1.Input />
          </Item>
        </antd_1.Col>
      </antd_1.Row>
...
exports.PaypalSettingFrom = PaypalSettingFrom;
